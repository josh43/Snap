...
static const NSString * baseURL =@"http://nodejssnap-jrm43.rhcloud.com:80";
//@"http://10.0.0.4:8080";
//@"http://nodejssnap-jrm43.rhcloud.com:80"
...
+(void)initializeDict{
    ...
    dict = @{// BEGIN GET
             ...
             @"storyList"               :@"getLastTimeFriendsUpdatedStory",
             @"getContent"              :@"getContent",
             @"queryProjection"         :@"queryWithProjection",
             @"query"                   :@"query",
             @"findUsers"               :@"findUsers",
             @"helloGet"                :@"helloGet",
